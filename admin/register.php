                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="lastName" placeholder="First Name">
                                </div>
                                <div class="form-group">
                                    <label>Mobile Number</label>
                                    <input class="au-input au-input--full" type="tel"  name="phoneNumber" placeholder="Phone Number">
                                </div>
                                <div class="form-group">
